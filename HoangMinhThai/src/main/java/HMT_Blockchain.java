...
public class HMT_Blockchain {

    public static ArrayList<VNPT_Thai> blockchain = new ArrayList<VNPT_Thai>();
    ...
    public static void main(String[] args) {
        ...
        VNPT_Thai genesis = new VNPT_Thai("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);

        //Thử nghiệm
        VNPT_Thai block1 = new VNPT_Thai(genesis.hash);
        ...
        addBlock(block1);
        System.out.println("\nSo luong VNPT_Net_Router trong kho con lai la: " + Kho.getBalance());
    ...
    public static Boolean isChainValid() {
        VNPT_Thai currentBlock;
        VNPT_Thai previousBlock;
    ...
    public static void addBlock(VNPT_Thai newBlock) {
